...
<div class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?php echo $link_prefix; ?>grand_total/grand-total.php?farm_id=<?php echo $current_farm_id; ?>&page=<?php echo $current_page_number; ?>" class="nav-item <?php echo $current_file == 'grand-total.php' ? 'active' : ''; ?>" data-page="grand-total">
